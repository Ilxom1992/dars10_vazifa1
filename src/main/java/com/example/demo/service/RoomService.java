...
//  CREATE
    ...
    public Result getHotelByIdRooms(Integer pages,Integer id){
        Optional<Hotel> optionalHotel = hotelRepository.findById(id);
        if (!optionalHotel.isPresent()){
            return new Result("Bunday Id li Hotel Mavjud emas",false);
        }
        Pageable pageable= PageRequest.of(pages,10);
        return new Result("Siz Kiritgan Hotel Roomlari ",true,roomRepository.findAllByHotel_Id(id,pageable));
    }
